...
import net.mazee.cozyfoods.block.custom.CabinetBlock;
...
public class CabinetBlockEntity extends RandomizableContainerBlockEntity
{
    ...
    private ContainerOpenersCounter openersCounter = new ContainerOpenersCounter()
    {
        protected void onOpen(Level level, BlockPos pos, BlockState state) {
            CabinetBlockEntity.this.playSound(state, SoundEvents.CHEST_OPEN);
            CabinetBlockEntity.this.updateBlockState(state, true);
        }

        protected void onClose(Level level, BlockPos pos, BlockState state) {
            CabinetBlockEntity.this.playSound(state, SoundEvents.CHEST_CLOSE);
